...
return [
    ...
    'Predefined Assets' => 'Vooraf gedefinieerde activa',
    'Select any Assets you wish to include as attachments on all email notifications using this template.' => 'Selecteer alle middelen die u als bijlage wilt toevoegen aan alle e-mailmeldingen die deze sjabloon gebruiken.',
    'Choose assets' => 'Kies activa',
    ...
    '180 days' => '180 dagen',
    '365 days' => '365 dagen',
    'Purge Unfinalized Asset Files' => 'Niet-gefinaliseerde activabestanden opschonen',
    'Select how long Freeform should keep unfinalized asset files before purging.' => 'Selecteer hoe lang Freeform niet-afgeronde itembestanden moet bewaren voordat deze wordt opgeschoond.',
    '1 hour' => '1 uur',
    '2 hours' => '2 uur',
    ...
    "Use Craft's queue system to trigger emails. Enabling this will speed up submission processing for your users. This depends on either routine traffic to your Craft control panel or implementing a proper queue-processing method that doesn't rely on someone visiting your control panel. <a class='go' href='https://craftcms.com/docs/5.x/system/queue.html' rel='noopener' target='_blank'>Learn more</a>" => "Gebruik het wachtrijsysteem van Craft om e-mails te activeren. Als u dit inschakelt, wordt de verwerking van inzendingen voor uw gebruikers versneld. Dit hangt af van routinematig verkeer naar uw Craft-controlepaneel of van het implementeren van een goede wachtrijverwerkingsmethode die niet afhankelijk is van iemand die uw controlepaneel bezoekt paneel <a class='go' href='https://craftcms.com/docs/5.x/system/queue.html' rel='noopener' target='_blank'>Meer informatie</a>",
    'Use Queue for Integrations' => 'Gebruik wachtrij voor integraties',
    "Use Craft's queue system to trigger integrations (CRM and Email Marketing). Enabling this will speed up submission processing for your users. This depends on either routine traffic to your Craft control panel or implementing a proper queue-processing method that doesn't rely on someone visiting your control panel. <a class='go' href='https://craftcms.com/docs/5.x/system/queue.html' rel='noopener' target='_blank'>Learn more</a>" => "Gebruik het wachtrijsysteem van Craft om integraties te activeren (CRM en e-mailmarketing). Als u dit inschakelt, wordt de verwerking van inzendingen voor uw gebruikers versneld. Dit is afhankelijk van routinematig verkeer naar uw Craft-controlepaneel of van het implementeren van een goede wachtrij. verwerkingsmethode die niet afhankelijk is van iemand die uw configuratiescherm bezoekt <a class='go' href='https://craftcms.com/docs/5.x/system/queue.html' rel='noopener' target. ='_blank'>Meer informatie</a>",
    ...
    'Asset Bundles (recommended)' => 'Activabundels (aanbevolen)',
    'Inline' => 'In lijn',
    ...
    'Display errors about blocked email(s) under each email field' => 'Toon fouten over geblokkeerde e-mail(s) onder elk e-mailveld',
    ...
    'Display errors about blocked keyword(s) under each text/textarea field' => 'Geef fouten weer over geblokkeerde trefwoord(en) onder elk tekst-/tekstgebiedveld',
    ...
    'The message shown to users when blocked keywords are submitted. Can use {value} and {keyword} variables.' => 'Het bericht dat aan gebruikers wordt getoond wanneer geblokkeerde trefwoorden worden ingediend. Kan de variabelen {value} en {keyword} gebruiken.',
    ...
    'Append checkbox group field values on Contact update' => 'Voeg veldwaarden van selectievakjesgroep toe bij update van contact',
